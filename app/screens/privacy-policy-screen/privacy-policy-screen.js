...
export const PrivacyPolicyScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        switch (language) {
            case 'English':
                setUrl('https://heradigitalhealth.org/privacy-policy/');
                break;
            case 'Arabic':
                setUrl('https://heradigitalhealth.org/ar/privacy-policy/');
                break;
            case 'Turkish':
                setUrl('https://heradigitalhealth.org/tr/gizlilik-politikasi/');
                break;
        }
    }, [language]);
    ...
    return (
        <View style={styles.FULL}>
            <SafeAreaView style={styles.SAFE_AREA_VIEW}>
                <ToolBar title={t('privacy_policy_toolbar_title')}
