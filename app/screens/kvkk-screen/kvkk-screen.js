...
export const KVKKScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        switch (language) {
            case 'English':
                setUrl('https://heradigitalhealth.org/data-protection-policy/');
                break;
            case 'Arabic':
                setUrl('https://heradigitalhealth.org/ar/data-protection-policy/');
                break;
            case 'Turkish':
                setUrl('https://heradigitalhealth.org/tr/kisisel-verilerin-korunmasi-politikasi/');
                break;
        }
    }, [language]);
    ...
    return (
        <View style={styles.FULL}>
            <SafeAreaView style={styles.SAFE_AREA_VIEW}>
                <ToolBar title={t('kvkk_toolbar_title')}
