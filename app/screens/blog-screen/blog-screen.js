...
export const BlogScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        switch (language) {
            case 'English':
                setUrl('https://heradigitalhealth.org/blog/');
                break;
            case 'Arabic':
                setUrl('https://heradigitalhealth.org/ar/blog/');
                break;
            case 'Turkish':
                setUrl('https://heradigitalhealth.org/tr/blog/');
                break;
        }
    }, [language]);
    ...
    return (
        <View style={styles.FULL}>
            <SafeAreaView style={styles.SAFE_AREA_VIEW}>
                <ToolBar title={t('health_tips_news_screen_toolbar_title')}
