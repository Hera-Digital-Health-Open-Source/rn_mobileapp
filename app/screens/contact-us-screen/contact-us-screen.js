...
export const ContactUsScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        switch (language) {
            case 'English':
                setUrl('https://heradigitalhealth.org/contact/');
                break;
            case 'Arabic':
                setUrl('https://heradigitalhealth.org/ar/contact/');
                break;
            case 'Turkish':
                setUrl('https://heradigitalhealth.org/tr/bize-ulasin/');
                break;
        }
    }, [language]);
    ...
    return (
        <View style={styles.FULL}>
            <SafeAreaView style={styles.SAFE_AREA_VIEW}>
                <ToolBar title={t('contact_us_screen_toolbar_title')}
